                    ...
                    <div align="center" style="margin-top: 40px;">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <img src="img/servidor.jpg" alt="Imagem Responsiva" class="img-thumbnail">
                            </div>
                            <div class="col-md-4">
                                <h2>Desenvolvimento</h2>
                                <img src="img/desenvolvimento.jpg" alt="Imagem Responsiva" class="img-thumbnail">
                            </div>
                            <div class="col-md-4">
                            </div>
                            <div class="col-md-4">
                                <h2>Suporte</h2>
                                <img src="img/suporte.jpg" alt="Imagem Responsiva" class="img-thumbnail">
                            </div>
                            <div class="col-md-4">
                                <h2>Consultoria</h2>
                                <img src="img/consultoria.jpg" alt="Imagem Responsiva" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                </div>
